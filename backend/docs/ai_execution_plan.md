...
None. F24 is complete; idle heartbeats should follow `backend/docs/ai_tasks/F21_heartbeat_development_operating_contract.md` to choose the next safe productization slice.
