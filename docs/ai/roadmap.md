...
- **us_trend_follow 逐日回放驗證（evaluation-only）**：walk-forward 回放 2026-06-15～06-30、兩套退出規則比較，證實 candidate_exit 太敏感、trend_protect 結構較合理；gate 本窗口未被壓力測試。**production 規則零改動**；結論與證據見 `docs/ai/us-trend-follow-replay-2026-06.md`。
